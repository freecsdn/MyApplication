...
import com.taole.universalimageloader.core.assist.FailReason.FailType;
import com.taole.universalimageloader.core.decode.ImageDecoder;
import com.taole.universalimageloader.core.decode.ImageDecodingInfo;
import com.taole.universalimageloader.core.download.ImageDownloader;
import com.taole.universalimageloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link com.taole.universalimageloader.core.imageaware.ImageAware} using {@link com.taole.universalimageloader.core.DisplayBitmapTask}.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see ImageLoaderConfiguration
 * @see com.taole.universalimageloader.core.ImageLoadingInfo
 * @since 1.3.1
 */
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	/**
	 * @throws com.taole.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if task is not actual (target ImageAware is collected by GC or the image URI of
	...
	/** @throws com.taole.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if target ImageAware is collected */
	...
	/** @throws com.taole.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if target ImageAware is collected by GC */
	...
	/** @throws com.taole.universalimageloader.core.LoadAndDisplayImageTask.TaskCancelledException if current task was interrupted */
