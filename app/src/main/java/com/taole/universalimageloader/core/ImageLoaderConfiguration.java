...
import com.taole.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.taole.universalimageloader.core.assist.FlushedInputStream;
import com.taole.universalimageloader.core.assist.ImageSize;
...
import com.taole.universalimageloader.core.process.BitmapProcessor;
import com.taole.universalimageloader.utils.L;
import com.taole.universalimageloader.utils.MemoryCacheUtils;
...
/**
 * Presents configuration for {@link com.taole.universalimageloader.core.ImageLoader}
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see com.taole.universalimageloader.core.ImageLoader
 * @see MemoryCache
 * @see DiskCache
 * @see com.taole.universalimageloader.core.DisplayImageOptions
 * @see com.taole.universalimageloader.core.download.ImageDownloader
...
public final class ImageLoaderConfiguration {
	...
	/**
	 * Creates default configuration for {@link com.taole.universalimageloader.core.ImageLoader} <br />
	 * <b>Default values:</b>
	 * <ul>
	 ...
	 * <li>threadPoolSize = {@link com.taole.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
	 * <li>threadPriority = {@link com.taole.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
	 ...
	 * <li>diskCache = {@link com.taole.universalimageloader.cache.disc.impl.UnlimitedDiscCache}</li>
	 ...
	 * <li>defaultDisplayImageOptions = {@link com.taole.universalimageloader.core.DisplayImageOptions#createSimple() Simple options}</li>
	 * <li>tasksProcessingOrder = {@link com.taole.universalimageloader.core.assist.QueueProcessingType#FIFO}</li>
	...
	/**
	 * Builder for {@link com.taole.universalimageloader.core.ImageLoaderConfiguration}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.taole.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * @param processorForDiskCache      null-ok; {@linkplain com.taole.universalimageloader.core.process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
		 */
		 ...
		 * <li>{@link #tasksProcessingOrder(com.taole.universalimageloader.core.assist.QueueProcessingType)}</li>
		 * </ul>
		 *
		 ...
		 * Default value - {@link com.taole.universalimageloader.core.assist.QueueProcessingType#FIFO}
		 */
		 ...
		 * {@link com.taole.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.taole.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.taole.universalimageloader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.taole.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.taole.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.taole.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.taole.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * BaseDiscCache}. Cache directory is defined by
		 * {@link com.taole.universalimageloader.utils.StorageUtils#getCacheDirectory(android.content.Context)
		 ...
		 * Default value -
		 * {@link com.taole.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(android.content.Context)
		 ...
		 * Default value -
		 * {@link com.taole.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		...
		/**
		 * Sets default {@linkplain com.taole.universalimageloader.core.DisplayImageOptions display image options} for image displaying. These options will
		 * be used for every {@linkplain com.taole.universalimageloader.core.ImageLoader#displayImage(String, android.widget.ImageView) image display call}
		 * without passing custom {@linkplain com.taole.universalimageloader.core.DisplayImageOptions options}<br />
		 * Default value - {@link com.taole.universalimageloader.core.DisplayImageOptions#createSimple() Simple options}
		 */
		...
		/**
		 * Enables detail logging of {@link com.taole.universalimageloader.core.ImageLoader} work. To prevent detail logs don't call this method.
		 * Consider {@link com.taole.universalimageloader.utils.L#disableLogging()} to disable
		...
		/** Builds configured {@link com.taole.universalimageloader.core.ImageLoaderConfiguration} object */
	 ...
	 * using {@link com.taole.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
