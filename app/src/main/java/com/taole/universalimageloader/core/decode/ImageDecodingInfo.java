 ...
 *******************************************************************************/
package com.taole.universalimageloader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.taole.universalimageloader.utils.MemoryCacheUtils#generateKey(String, com.taole.universalimageloader.core.assist.ImageSize) image key} (used in memory cache). */
	...
	/**
	 * @return Target size for image. Decoded bitmap should close to this size according to {@linkplain com.taole.universalimageloader.core.assist.ImageScaleType
	 * image scale type} and {@linkplain com.taole.universalimageloader.core.assist.ViewScaleType view scale type}.
	 */
	...
	/**
	 * @return {@linkplain com.taole.universalimageloader.core.assist.ImageScaleType Scale type for image sampling and scaling}. This parameter affects result size
	 * of decoded bitmap.
	 */
	...
	/** @return {@linkplain com.taole.universalimageloader.core.assist.ViewScaleType View scale type}. This parameter affects result size of decoded bitmap. */
