 ...
 *******************************************************************************/
package com.taole.universalimageloader.utils;
...
public final class StorageUtils
{
    ...
    private static File getExternalCacheDir(Context context)
    {
        ...
        // File(Environment.getExternalStorageDirectory(), "Taole"), "image");
        File appCacheDir = new File(context.getCacheDir() + "/images/");
    ...
    public static void changeCache(String path, Context context)
    {
        if(TextUtils.isEmpty(path)){
            path = context.getCacheDir() + "/images/";
        }
        Class clz = ImageLoader.class;
        Field engine;
        try
        {
            engine = clz.getDeclaredField("engine");
            engine.setAccessible(true);
            Object imageEngine = engine.get(ImageLoader.getInstance());
            Class engineClz = imageEngine.getClass();
            Field configuration = engineClz.getDeclaredField("configuration");
            ...
            configuration.set(
                    ...
                    new ImageLoaderConfiguration.Builder(context)
                            ...
                            .diskCache(new UnlimitedDiscCache(new File(path)))
