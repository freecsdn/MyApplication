...
import com.taole.common.adapter.ImageListAdapter;
import com.taole.common.utils.ImageChooseUtil;
...
public class ImageListActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void onBackPressed() {
        if (mImageAdapter != null) {
            ImageChooseUtil.saveSelectedImags(this, mImageAdapter.getSelectedImgs());
        }
        super.onBackPressed();
    }
