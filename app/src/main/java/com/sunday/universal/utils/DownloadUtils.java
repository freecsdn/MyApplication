...
public class DownloadUtils implements Serializable {
     ...
     */
    public DownloadUtils(int downloadId, String url, String localPath) {
     ...
     * @return this
     */
    public DownloadUtils setOnDownloadListener(OnDownloadListener listener) {
        mListener = listener;
        return this;
    }
...
//                  Log.i(TAG,(int)(downloadedLength/(float)remoteFileLength * 100));
                    if ((int) (downloadedLength / (float) remoteFileLength * 100) % 10 == 0) {
                        ...
                        handler.sendMessage(msg);
//                      Log.i(TAG,mDownloadId + "已下载" + downloadedLength);
                    }
...
DownloadUtils d = new DownloadUtils(1, "http://baidu.com/test.zip",
        "/sdcard/download/");
