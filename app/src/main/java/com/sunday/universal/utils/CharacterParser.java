...
public class CharacterParser {
    ...
    public static void main(String args[]){
        String str = "hangzhou中国sdas";
        System.out.println(pyvalue.length);
        System.out.println(pystr.length);
        System.out.println(CharacterParser.getInstance().getSelling(str));
