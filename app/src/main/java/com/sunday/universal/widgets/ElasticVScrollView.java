...
public class ElasticVScrollView extends ScrollView {
	private View inner;
	private float y;
	private Rect normal = new Rect();
	private boolean animationFinish = true;

	public ElasticVScrollView(Context context) {
		super(context);
	}

	public ElasticVScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
